...
public final class TcRuntime60Detector extends TcRuntimeDetector {
    ...
    protected boolean isMyTomcatVersion(String catalinaHome, String catalinaBase) {
        boolean tomcat7 = new File(catalinaHome, TOMCAT_7_SPECIFIC_JAR).exists();
        boolean tomcat8 = new File(catalinaHome, TOMCAT_8_SPECIFIC_JAR).exists();
        return !(tomcat7 || tomcat8);
    }
}

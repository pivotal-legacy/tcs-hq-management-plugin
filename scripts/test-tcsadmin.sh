...
# 
# In what directory does the tcsadmin runtime distribution live? 
# 
TCSADM_DIR=${TCS_APP_DIR:-$USER_DIR/hq}/springsource-tcserver-scripting-client}

# 
# Include the test-tcsadmin-functions.sh script 
# 
init() {
    . $SCRIPT_DIR/test-tcsadmin-functions.sh
}
...
# test-tcsadmin-functions.sh script to all functions that model various scenarios for

...
/**
 * Exception while communicating with HQ. The message will often be displayed
 * directly to the end-user as an error.
 * 
 * @since 2.0
 */
public class SettingsLoaderException extends Exception {

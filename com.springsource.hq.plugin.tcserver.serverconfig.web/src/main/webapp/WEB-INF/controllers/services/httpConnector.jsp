...
<div id="content">
  ...
  <h1>
    Settings for <c:out value="${service.name}" /> HTTP Connector <c:out value="${httpConnector.connectorName}" />
  ...
  <form:form modelAttribute="httpConnector" method="put">
    <jsp:include page="httpConnector-inc.jsp" />
    <br />
    <c:if test="${!readOnly}">

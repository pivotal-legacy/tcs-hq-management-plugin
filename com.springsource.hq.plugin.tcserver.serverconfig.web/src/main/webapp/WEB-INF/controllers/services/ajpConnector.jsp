...
<div id="content">
  ...
  <h1>
    Settings for AJP Connector <c:out value="${ajpConnector.connectorName}" />
    <a class="help-link allow-unsaved-changes" 
       href="/ui_docs/DOC/ui-tcserver.ServerServicesRef.html"
       target="help">
       <img src="<c:url value="/resources/images/help.png" />">
    </a>
  </h1>
  
  <form:form modelAttribute="ajpConnector" method="put">

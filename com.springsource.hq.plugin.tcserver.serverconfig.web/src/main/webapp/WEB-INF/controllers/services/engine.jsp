...
<div id="content">
  ...
  <h1>
    Settings for <c:out value="${service.name}" /> Engine
    <a class="help-link allow-unsaved-changes" 
       href="/ui_docs/DOC/ui-tcserver.ServerServicesRef.html#ui-tcserver.ServerServicesRef-EngineProperties"
       target="help">
  ...
  <form:form action="${url}" modelAttribute="engine" method="put">
    <jsp:include page="engine-inc.jsp" />
    <br />
    <spring:nestedPath path="threadDiagnostics">
      <jsp:include page="threadDiagnostics-inc.jsp" />
    </spring:nestedPath>
    <br />
    <spring:nestedPath path="logging">
      <jsp:include page="logging-inc.jsp" />
    </spring:nestedPath>
    <br />
    <c:if test="${!readOnly}">

...
<div id="content">
  ...
  <h1>
    Settings for <c:out value="${tomcatDataSource.general.jndiName}" />
  ...
  <spring:url value="/app/{settingsId}/resources/jdbc/tomcat/{dataSourceId}/" var="url">
    <spring:param name="settingsId" value="${settings.humanId}" />
    <spring:param name="dataSourceId" value="${tomcatDataSource.humanId}" />
  </spring:url>
  <form:form action="${url}" modelAttribute="tomcatDataSource" method="put">
  ...
  <spring:hasBindErrors name="tomcatDataSource">
    <script type="text/javascript">
   	  console.info("Calling ams.openAllBlinds function");

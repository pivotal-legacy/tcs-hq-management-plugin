...
<div id="content">
  ...
  <spring:url value="/app/{settingsId}/resources/jdbc-new/" var="url">
    <spring:param name="settingsId" value="${settings.humanId}" />
  </spring:url>
  <form:form action="${url}" modelAttribute="dataSource" method="post">
  ...
  <spring:hasBindErrors name="dataSource">
